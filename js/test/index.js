...
function processVideo() {
  ...
  // outputContext.clearRect(0, 0, resolution.width, resolution.height);
  ...
  openCV.cvtColor(srcMat, grayMat, openCV.COLOR_RGB2GRAY);
  ...
  openCV.HoughCircles(grayMat, circleMat, openCV.HOUGH_GRADIENT, 1, 35, 150, 28, 5, 60);
  ...
  // openCV.kmeans(srcMat, 2, grayMat, [openCV.TERM_CRITERIA_EPS + openCV.TERM_CRITERIA_MAX_ITER, 10, 1.0], 10, openCV.KMEANS_RANDOM_CENTERS); 
  ...
  // Draw.
  // openCV.imshow(processingCanvas, maskMat);
